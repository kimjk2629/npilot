...
class LongitudinalPlanner:
  ...
  def publish(self, sm, pm):
    ...
    v_target_mpc, a_target_mpc, should_stop_mpc = get_accel_from_plan(self.CP, longitudinalPlan.speeds, longitudinalPlan.accels)
    ...
    if sm['controlsState'].experimentalMode:
      ...
      v_target_model, a_target_model, should_stop_model = get_accel_from_plan(self.CP, model_speeds, model_accels)
      a_target = min(a_target_mpc, a_target_model)
      v_target = min(v_target_mpc, v_target_model)
      should_stop = should_stop_mpc or should_stop_model
    else:
      a_target = a_target_mpc
      v_target = v_target_mpc
